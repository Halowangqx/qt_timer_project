...
#define CIRQUERADIUS     67        //时钟半径
#define CIRQUEWIDTH      7         //时钟圆环宽度
#define SMALLCIRQUEWIDTH 2          //进度圆环的宽度
#define FONTPOINTSIZE    8         //时钟数字字体大小
#define BELLICONSIZE     10         //闹铃、调节按钮图标初始大小
#define STARTICONSIZE    22         //开始重置图标初始大小
#define LCDNUMBERHEIGHT  37         //LCD数字初始高度
#define SWITCHBUTTONSIZE 10         //计时器模式切换按钮初始大小
...
void QBStopWatch::CreateUI()
{
    ...
    finishbutton=CreatecommonBtn(QIcon("://finish.png"),QSize(BELLICONSIZE,BELLICONSIZE));
    ...
    m_closeBtn = CreatecommonBtn(QIcon("://closeTool.svg"),QSize(24,24));
...
void QBStopWatch::on_finish_slot()
{
    ...
    initinfor.end_time=QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss");
    ...
    initinfor.last_time=last_time;
    emit signal2_3(initinfor);
    //on_startstop_slot();
}
...
{   
    ...
    startPic.load(QString("://start2.svg"));
    ...
    resetPic.load(QString("://reset.svg"));
